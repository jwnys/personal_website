...
"aug", "sep", "oct", "nov", "dec"];
            ...
            this.match = function(s, canCommentOut) {
                ...
                if (this.input.substring(this.pos, this.pos + s.length) == s) {
                    ...
                    throw TypeError("Token mismatch: match", "expected " + s +
", found "
            ...
            /* when search for a match all text can be ignored, not just white 
 space */
                ...
                while (true) {
                    if (!escaped) {
                        if (this.input[this.pos] == '"') {
                            ...
                            throw TypeError("Unterminated value: value_quotes", 
            ...
            this.single_value = function() {
                ...
                if (this.tryMatch("{")) {
                    ...
                    if (k.match("^[0-9]+$"))
                        ...
                        throw "Value expected: single_value" + 
this.input.substring(start) + ' for key: ' + k;
                ...
                this.entries.forEach(function (entry) {
                    if (!entry.citationKey && entry.entryTags) {
                        ...
                        if (entry.entryTags.author) {
                            entry.citationKey += 
entry.entryTags.author.split(',')[0] += ', ';
                        }
